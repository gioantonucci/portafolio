  ...
  return (
    <section className="font-Rubik  bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400">
      <div className="container lg:mx-20 px-5 py-24">
        ...
        <div className="card mb-5 bg-opacity-75 lg:card-side bg-base-100 shadow-xl">
          <figure>
            <img className="w-fit h-52" src={AVATAR} alt="Juego de Avatar" />
          </figure>
          <div className="card-body">
            <h2 className="card-title uppercase"><FormattedMessage
            id="title.avatar" defaultMessage="AVATAR GAME"/></h2>
            <p>
            <FormattedMessage
            id="description.avatar" defaultMessage="Juego del estilo piedra, papel o tijera. Realizado para reforzar conocimientos y buenas prácticas. Hecho con JS, HTML y CSS."/>
            </p>
            <div className="card-actions justify-end">
              <a
                target="_blank"
