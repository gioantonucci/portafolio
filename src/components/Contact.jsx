...
function Contact() {
  return (
    <section className= "bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 text-gray-600 body-font relative">
    <div className="container px-5 py-24 mx-auto">
      <div className="flex flex-col text-center w-full mb-12">
        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Contactame!</h1>
