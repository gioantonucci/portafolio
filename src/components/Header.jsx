  ...
  return (
    <section className="font-Over bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400">
      <div className="container px-6 py-8 mx-auto">
        <h2
          className="flex flex-col 12xl justify-center items-center lg:text-8xl bg-cover text-6xl bg-clip-text bg-center uppercase text-transparent font-extrabold tracking-wide antialiased"
          style={{
            backgroundImage:
