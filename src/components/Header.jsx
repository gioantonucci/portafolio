  ...
  return (
    <section className="h-screen flex justify-center items-center font-Over bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400">
      <div className="container m-2">
        <h2
          className="flex justify-center items-center bg-cover sm:text-5xl lg:text-9xl bg-clip-text bg-center uppercase text-transparent font-extrabold tracking-wide antialiased"
          style={{
            backgroundImage:
