...
function Skills() {
  return (
    <section className="font-Rubik bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400">
      ...
      <div className="lg:mx-20 px-5 flex justify-center items-center ">
        <div className="container  p-6 rounded opacity-75 bg-white">
          <div className="p-4 mx-auto text-center"></div>
          <div className="flex flex-wrap justify-center mx-auto dark:text-gray-400">
            <div
              className="flex justify-center items-center tooltip tooltip-primary w-1/2 p-6  md:w-1/3 xl:w-1/4"
              data-tip="Javascript"
            >
            ...
            <div
              className="flex justify-center tooltip tooltip-primary w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4"
              data-tip="HTML"
            >
