    ...
    <section className="font-Over bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400">
      <div className="container px-6 py-8 mx-auto">
        ...
        <div className="flex mx-auto">
          <div class="w-24 mr-2 rounded-xl">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" />
          </div>
          <div class="w-24 mr-2 rounded-xl">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original-wordmark.svg" />
          </div>
          <div class="w-24 mr-2 placeholder:rounded-xl">
          ...
          <div className="flex mx-auto">
          <div class="w-24 mt-4 mr-2 rounded-xl">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original-wordmark.svg" />
          </div>
          <div class="w-24 mr-2 rounded-xl">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original-wordmark.svg" />
          </div>
          <div class="w-24 mt-4 mr-2 placeholder:rounded-xl">
